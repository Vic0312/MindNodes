...
if (!AuthController::recuperacaoValida()) {
...
<head>
    ...
    <title>MindNodes - Redefinir senha</title>
    ...
    <section class="login-container">
        ...
        <form method="POST" action="../processamento/processamento.php">
            ...
            <section class="input-box">
                ...
                <input type="password" name="novaSenha" placeholder="Nova senha" aria-label="Nova senha" autocomplete="new-password" minlength="8" required>
            </section>
            <section class="input-box">
                <i class="fa-solid fa-lock"></i>
                <input type="password" name="confirmacao" placeholder="Confirmar nova senha" aria-label="Confirmar nova senha" autocomplete="new-password" minlength="8" required>
            </section>
